...
import { editSeo, fetchHome, useAppDispatch } from './store';
...
const Seo = ({ data , homeId }: props) => {    
    ...
    const onFormSubmit = async (
        ...
        try {
            setSubmitting(true);
            const response = await dispatch(editSeo({ id: homeId , values: values }));
            
            if(response.meta.requestStatus == 'fulfilled'){
                dispatch(fetchHome())
                toast.push(<Notification title={'Home Seo updated'} type="success" />, {
