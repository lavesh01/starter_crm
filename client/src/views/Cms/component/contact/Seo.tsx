...
import { editSeo, fetchContact, useAppDispatch } from './store';
...
const Seo = ({ data, contactId }: props) => {
    ...
    const onFormSubmit = async (
        ...
        try {
            setSubmitting(true);
            const response = await dispatch(editSeo({ id: contactId, values: values }));
            if(response.meta.requestStatus == 'fulfilled'){
                dispatch(fetchContact())
                toast.push(<Notification title={'Contact Seo updated'} type="success" />, {
