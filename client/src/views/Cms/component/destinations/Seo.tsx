...
import { editSeo, fetchDestinationById, useAppDispatch } from './store';
...
const Seo = ({ }: props) => {
    ...
    const [ data , setData ] = useState<SeoFormModel>();
    ...
    const onFormSubmit = async (
        ...
        try {
            setSubmitting(true);
            const response = await dispatch(editSeo({ id: destinationId, values: values }));
            if(response.meta.requestStatus == 'fulfilled'){
                toast.push(<Notification title={'Destination Seo updated'} type="success" />, {
