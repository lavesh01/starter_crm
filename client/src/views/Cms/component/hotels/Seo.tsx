...
import { editSeo, fetchHotelById, useAppDispatch } from './store';
...
const Seo = ({ }: props) => {
    ...
    const onFormSubmit = async (
        ...
        try {
            setSubmitting(true);
            const response = await dispatch(editSeo({ id: hotelId, values: values }));
            if(response.meta.requestStatus == 'fulfilled'){
                toast.push(<Notification title={'Hotel Seo updated'} type="success" />, {
